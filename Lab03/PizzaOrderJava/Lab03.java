...
switch(crustType){
    ...
    case 'd':
        ...
        break;
    default:
        System.out.println("User input was not one of the choices, so a Hand-tossed crust will be made");
        crust = "Hand-tossed";       
}
...
System.out.printf("The cost of your order is: $%.2f", cost);
System.out.println("");
// Calculate and display tax and total cost.
tax = cost * TAX_RATE;
System.out.printf("The tax is: $%.2f", tax);
System.out.println("");
System.out.printf("The total due is: $%.2f", (tax + cost));
System.out.println("");
